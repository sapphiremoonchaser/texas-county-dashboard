...
demographics_profile = census_client.demographics_profile()

demographics_profile.to_csv(
    "C:/Users/viole/dev/projects/portfolio/texas-county-dashboard/src"
    "/texas_county_dashboards/data/processed/texas_demographics_profile.csv",
    index=False
)
